...
pcd_combined = o3d.io.read_point_cloud("D:\lidar\point\copy_of_fragment.pcd")
# 读取点云数据
pcd_grond = o3d.io.read_point_cloud("D:\lidar\point\grond.pcd")

pcd_nongrond= o3d.io.read_point_cloud("D:\lidar\point\\nongrond.pcd")
